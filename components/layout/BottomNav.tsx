...
interface BottomNavProps {
  activePage?: "home" | "sell" | "messages" | "profile";
}
        ...
        <div className="flex justify-around py-3">
          <Link
            ...
            className={`flex flex-col items-center gap-1 ${
              activePage === "home" ? "text-white" : "text-gray-400"
            }`}
          >
          ...
          <Link
            href="/messages"
            className={`flex flex-col items-center gap-1 ${
              activePage === "messages" ? "text-white" : "text-gray-400"
            }`}
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
          ...
          <Link
            href="/profile"
            className={`flex flex-col items-center gap-1 ${
              activePage === "profile" ? "text-white" : "text-gray-400"
            }`}
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
              <path
